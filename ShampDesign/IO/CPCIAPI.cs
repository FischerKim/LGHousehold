...
namespace ShampDesign
{
    public class CPCI7230
    {
        ...
        public const short ErrorInvalidCounterValue = -50; //Uhankimb
        ...
        ** PCIS-DASK Function prototype
        ...
        [DllImport("PCI-Dask.dll")]
        public static extern short AI_VoltScale(ushort CardNumber, ushort AdRange, short reading, out double voltage);
        [DllImport("PCI-Dask.dll")]
        ...
        [DllImport("PCI-Dask.dll")]
        public static extern short AI_ContVScale(ushort wCardNumber, ushort adRange, short[] readingArray, double[] voltageArray, int count);
        [DllImport("PCI-Dask.dll")]
        public static extern short AI_AsyncCheck(ushort CardNumber, out bool Stopped, out uint AccessCnt);
        [DllImport("PCI-Dask.dll")]
        public static extern short AI_AsyncClear(ushort CardNumber, out uint AccessCnt);
        [DllImport("PCI-Dask.dll")]
        public static extern short AI_AsyncDblBufferHalfReady(ushort CardNumber, out bool HalfReady, out bool StopFlag);
        [DllImport("PCI-Dask.dll")]
        ...
        [DllImport("PCI-Dask.dll")]
        public static extern short AI_EventCallBack(ushort CardNumber, short mode, short EventType, uint callbackAddr);
        /*---------------------------------------------------------------------------*/
        [DllImport("PCI-Dask.dll")]
        ...
        [DllImport("PCI-Dask.dll")]
        public static extern short DI_ContReadPort(ushort CardNumber, ushort Port, short Buffer,
        ...
        [DllImport("PCI-Dask.dll")]
        public static extern short DI_AsyncCheck(ushort CardNumber, out bool Stopped, out uint AccessCnt);
        [DllImport("PCI-Dask.dll")]
        public static extern short DI_AsyncClear(ushort CardNumber, out uint AccessCnt);
        [DllImport("PCI-Dask.dll")]
        public static extern short DI_AsyncDblBufferHalfReady(ushort CardNumber, out bool HalfReady);
        [DllImport("PCI-Dask.dll")]
        ...
        [DllImport("PCI-Dask.dll")]
        public static extern short DI_AsyncMultiBufferNextReady(ushort CardNumber, out bool bNextReady, out ushort wBufferId);
        [DllImport("PCI-Dask.dll")]
        public static extern short DI_AsyncDblBufferOverrun(ushort CardNumber, ushort op, out ushort overrunFlag);
        [DllImport("PCI-Dask.dll")]
        public static extern short DI_EventCallBack(ushort CardNumber, short mode, short EventType, uint callbackAddr);
        /*---------------------------------------------------------------------------*/
        [DllImport("PCI-Dask.dll")]
        ...
        [DllImport("PCI-Dask.dll")]
        public static extern short DO_ContWritePort(ushort CardNumber, ushort Port, short[] Buffer,
        ...
        [DllImport("PCI-Dask.dll")]
        public static extern short DO_AsyncCheck(ushort CardNumber, out bool Stopped, out uint AccessCnt);
        [DllImport("PCI-Dask.dll")]
        ...
        [DllImport("PCI-Dask.dll")]
        public static extern short DO_AsyncMultiBufferNextReady(ushort CardNumber, out bool bNextReady, out ushort wBufferId);
        [DllImport("PCI-Dask.dll")]
        public static extern short DO_ContMultiBufferStart(ushort wCardNumber, ushort wPort, double fSampleRate);
        [DllImport("PCI-Dask.dll")]
        public static extern short DO_EventCallBack(ushort CardNumber, short mode, short EventType, uint callbackAddr);
        /*---------------------------------------------------------------------------*/
        [DllImport("PCI-Dask.dll")]
        ...
        [DllImport("PCI-Dask.dll")]
        public static extern short DIO_INT1_EventMessage(ushort CardNumber, short Int1Mode, long windowHandle, long message, long callbackAddr);
        [DllImport("PCI-Dask.dll")]
        public static extern short DIO_INT2_EventMessage(ushort CardNumber, short Int2Mode, long windowHandle, long message, long callbackAddr);
        [DllImport("PCI-Dask.dll")]
        public static extern short DIO_7300SetInterrupt(ushort CardNumber, short AuxDIEn, short T2En, long hEvent);
        [DllImport("PCI-Dask.dll")]
        public static extern short DIO_AUXDI_EventMessage(ushort CardNumber, short AuxDIEn, long windowHandle, uint message, long callbackAddr);
        [DllImport("PCI-Dask.dll")]
        public static extern short DIO_T2_EventMessage(ushort CardNumber, short T2En, long windowHandle, uint message, long callbackAddr);
        [DllImport("PCI-Dask.dll")]
